...
@Tag(name = "REST API for Customers in MyBank", description = "REST APIs in MyBank to FETCH customer details")
@RestController
...
public class CustomerController {
	...
	public ResponseEntity<CustomerDetailsDto> fetchCustomerDetails(@RequestHeader("mybank-correlation-id")
